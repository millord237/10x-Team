#!/usr/bin/env python3
"""
10x Team Help Command - All-in-one guide with dynamic command discovery.
...
CATEGORY_GUIDES = {
    ...
    "config": {
        "title": "10x Team Configuration (.ck.json)",
        "workflow": [
...
def show_config_guide() -> None:
    ...
    print("# 10x Team Configuration (.ck.json)")
    print()
