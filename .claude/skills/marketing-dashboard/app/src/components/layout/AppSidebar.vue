  ...
  >
    ...
    <div class="px-3 py-4 border-b border-border flex items-center" :class="collapsed ? 'justify-center' : 'justify-between'">
      <div class="flex items-center" :class="collapsed ? '' : 'space-x-3'">
        <img src="/ck-logo.png" alt="10x Team" class="w-8 h-8 flex-shrink-0" />
        <h1 v-if="!collapsed" class="text-lg font-heading font-bold text-gradient whitespace-nowrap">10x Team</h1>
      </div>
      <button
        v-if="!collapsed"
        @click="toggleSidebar"
