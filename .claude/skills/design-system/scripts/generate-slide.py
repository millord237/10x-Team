...
def main():
    ...
    if args.demo:
        ...
        demo_slides = [
            ...
            {
                'type': 'testimonial',
                'quote': '10x Team replaced 3 tools and 2 contractors. Our content output tripled while costs dropped 60%.',
                'author': 'Sarah Chen',
            ...
            },
            {
                ...
                'contact': 'hello@10x Team.ai',
                'website': '10x Team.ai'
            }
        ]

        html = generate_deck(demo_slides, "10x Team - Pitch Deck")
