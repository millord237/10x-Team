...
function generateCardMeta(plan) {
  ...
  // Issue tag - clickable link to GitHub (uses branch to derive repo, falls back to 10x Team)
  if (plan.issue) {
    // TODO: Make repo configurable via project settings
    const issueUrl = `https://github.com/10x Team/10x Team/issues/${plan.issue}`;
