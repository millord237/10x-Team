/**
 * 10x Team Browser Controller - Popup Script
 *
...
document.addEventListener('DOMContentLoaded', async () => {
  console.log('[10x Team Popup] Initializing...');
  ...
  console.log('[10x Team Popup] Initialized');
});
...
async function updateConnectionStatus() {
  try {
    ...
    console.error('[10x Team Popup] Error checking connection:', error);
...
async function updateActivityStats() {
  ...
  try {
    ...
    console.error('[10x Team Popup] Error loading activity stats:', error);
  }
}
...
async function updateRateLimits() {
  ...
  try {
    ...
    console.error('[10x Team Popup] Error loading rate limits:', error);
  }
}
...
function setupEventListeners() {
  ...
  document.getElementById('reconnect-btn').addEventListener('click', async () => {
    console.log('[10x Team Popup] Manual reconnect requested');
    ...
    try {
      ...
      console.error('[10x Team Popup] Reconnect failed:', error);
  ...
  document.getElementById('clear-stats-btn').addEventListener('click', async () => {
    ...
    try {
      ...
      console.log('[10x Team Popup] Stats cleared');
      ...
      console.error('[10x Team Popup] Error clearing stats:', error);
