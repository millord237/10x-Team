...
// manifest.json
{
  "name": "10x Team Browser Controller",
...
```json
// com.10x Team.browser.json (place in native messaging host directory)
{
  "name": "com.10x Team.browser",
  "description": "10x Team Browser Controller Native Host",
...
│   └── com.10x Team.browser.json # Native host manifest
├── utils/
