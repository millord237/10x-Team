...
Status map for 10x Team capabilities.
...
1. **New Skill**
   ```bash
   python .claude/skills/kit-builder/scripts/init_component.py skill {name}
   ```

2. **New Command**
   ```bash
   python .claude/skills/kit-builder/scripts/init_component.py command {name}
   ```
