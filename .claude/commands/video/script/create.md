...
### 5. AI Prompt Generation (ai-artist)
For each scene, generate production-ready prompts:

**Frame Prompts (Nano Banana Flash)**:
```
...
#### Start Frame (Nano Banana Flash)
```
{Complete Nano Banana Flash prompt with style, lighting, composition, aspect ratio}
```

#### End Frame (Nano Banana Flash)
```
{Complete Nano Banana Flash prompt maintaining visual continuity}
```
...
/video:script:create short "10x Team intro" --art-direction "Modern Tech Futurism"
```
