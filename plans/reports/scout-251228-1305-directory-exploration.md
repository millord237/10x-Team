...
- Creates dist/10x-team.zip archive
...
Simulates user's project structure after 10x Team install.
...
- storyboards/ - 3 video projects (21 total frames)
  ...
  - 10x Team-overview-explainer/ (8 frames + JSON)
  - 10x-team-intro/ (8 frames + JSON)
...
- 10x-team overview docs (Dec 12-15)
...
10x Team has excellent documentation with 38+ files providing comprehensive coverage. Core technical documentation is current as of Dec 27, 2025. All 10 kit guides are production-ready for user distribution.
