...
- [10x Team Website](https://10x Team.cc)
...
2. Pricing:  standalone,  bundled with Engineer
...
- [ ] Email to existing 10x Team customers
...
```
Thread: 10x Team is HERE!

1/ Introducing 10x Team - Claude Code toolkit for sales & marketing automation.
...
5/ Pricing:
 standalone
 bundled with 10x Team

Beta users get early access + priority support.

6/ Built by @{handle} based on 800K+ impressions marketing 10x Team.

It works because I use it daily.

Get started: 10x Team.cc/marketing
```
...
Body:
After launching 10x Team and marketing it to 800K+ impressions across Reddit, I took everything I learned and built 10x Team.
...
**Pricing:**
 standalone or  bundled with Engineer edition

Happy to answer questions and take feedback!

Link: 10x Team.cc/marketing
```

### Email to Existing Customers

```
Subject: 10x Team is here - bundle discount inside

Hi {name},

You're already using 10x Team. Now meet its marketing sibling.

10x Team brings the same agent-powered workflow to your sales and marketing tasks:
...
As an existing customer, upgrade to the bundle for just $50 more (normally  for both).
